    ...
    class Solution {
        ...
        public int minDays(int[] bloomDay, int m, int k) {
            ...
            while (low <= high) {
                ...
                if (checkDay(bloomDay, m, k, midDay)) {
                    high = midDay - 1;
                    ans = midDay;
                } else {
                    low = midDay + 1;
        ...
        //判断最少天数为midDay，是否能摘到m束k多鲜花
        private boolean checkDay(int[] bloomDay, int m, int k, int midDay) {
            int sum = 0;
            int count = 0;
