...
public class BinaryTreeTilt {
    ...
    class Solution {
        ...
        private int sumRoot(TreeNode root) {
            if (root == null) {
                return 0;
            }
            int leftSum = sumRoot(root.left);
            int rightSum = sumRoot(root.right);
            dilt += Math.abs(leftSum - rightSum);
